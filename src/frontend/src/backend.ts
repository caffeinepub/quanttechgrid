...
export class Backend implements backendInterface {
    ...
    async getAllPilotRequests(): Promise<Array<PilotRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPilotRequests();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async submitPilotRequest(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitPilotRequest(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
