      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          >
            ...
            <h2 className="font-display font-bold text-3xl sm:text-4xl lg:text-5xl tracking-tight text-foreground mb-6 leading-tight">
            ...
            <div className="grid gap-px bg-border">
              {signals.map((signal, i) => (
                <motion.div
                  ...
                  className="bg-card p-6 flex gap-6 items-start"
                >
